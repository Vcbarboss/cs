                        ...
                        <View style={{flex: 1, flexDirection: "row", marginHorizontal: 15, marginVertical: 10}}>
                          ...
                          <View style={{flex: 0.3,}}>
                            ...
                            <View style={{flex: 1, alignItems: "flex-end", justifyContent: "flex-end"}}>
                              <Text
                                  style={[item.read_at ? styles.read : styles.notRead, {fontSize: Texts.listDescription}]}>{moment(item.created_at.substr(0, 10)).fromNow()}</Text>
                            </View>
                          </View>
                        </View>
                      </TouchableOpacity>,
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  ...
                  <FilterNotification title={'Filtre suas notificações'} list={list} selected={filter.label} close={(e) => setFilterModal(e)} select={(item) => {
