            ...
            <ScrollView style={{
              ...
              <View style={{flexDirection: 'row', backgroundColor: Colors.theme,  padding: 20}}>
                ...
                <View style={{ flex: 1, justifyContent: "center", paddingLeft: 10 }}>
                  ...
                  <Text style={{ color: "white", fontSize: Texts.subtitle, }}> Conteúdo da Notificação </Text>
                </View>
              </View>

              <View style={{ flex: 1, backgroundColor: "white" }} onPress={() => navigation.navigate("StudentScreen")}>
                <View style={{ flex: 1, marginHorizontal: 20 }}>
                  ...
                  {data?.object.push_notification.survey_description ?
                    <View style={{marginVertical: 10}}>
                      <View>
                        <Text style={{textAlign: 'center', color: Colors.primary,fontWeight: 'bold',fontSize: 16}}>{data?.object.push_notification.survey_description}</Text>
                      </View>
                              ...
                              {Platform.OS !== "ios" ?
                                <View style={{
                                  ...
                                  <TouchableOpacity style={{flex: 1}}
                                    onPress={() => handleAnswer("unique", item.answer)}>
                                    <Text style={{ fontSize: 12, maxWidth: "100%" }}> {item.answer}</Text>
                                  </TouchableOpacity>
                                </View>
                                ...
                                <>
                                  ...
                                  <TouchableOpacity
                                    onPress={() => handleAnswer("unique", item.answer)}>
                                    <Text
                                      style={{ fontSize: 12, maxWidth: "100%", color: Colors.primary }}>{item.answer}
                                    </Text>
                                  </TouchableOpacity>
                                </>
                              }
