  ...
  return (
    <ErrorBoundary screenType={'initialStack'}>
        ...
        <StudentStack.Navigator initialRouteName={'StudentScreen'}>
          ...
          <StudentStack.Screen name={'AuthPersonListScreen'} initialParams={props} component={AuthPersonListScreen} options={{
            headerShown: false,
            gesturesEnabled: false,
            animationEnabled: false,
          }}/>
          ...
          <StudentStack.Screen name={'FormListScreen'} initialParams={props} component={FormListScreen} options={{
            headerShown: false,
            gesturesEnabled: false,
            animationEnabled: false,
          }}/>

          <StudentStack.Screen name={'FormEditScreen'} initialParams={props} component={FormEditScreen} options={{
            headerShown: false,
            gesturesEnabled: false,
            animationEnabled: false,
          }}/>
          ...
          <StudentStack.Screen name={'StudentNotificationList'} initialParams={props} component={StudentNotificationList} options={{
            headerShown: false,
            gesturesEnabled: false,
            animationEnabled: false,
          }}/>
